    ...
    <Grid container direction="column">
      ...
      >
        <Grid item lg>
          <img
            src={vision}
            alt=" mountain view in binoculars"
            style={{ maxWidth: matchesSM ? '400px':"40em", marginRight: matchesMD ? 0: "5em", marginBottom: matchesMD ? '5em': 0 }}
          />
        </Grid>
      ...
      >
        ...
        <Grid item container lg justify={matchesMD ? 'center':'flex-end'}>
          <Lottie
            ...
            style={{ maxWidth: "40em", margin: 0 }} // margin 0 is needed to get rid of default margin around animation, and be able to use justify flex-end to push animation to far right on larger screen.
          />
        </Grid>
      </Grid>
      <Grid item container 
      ...
      >
        <Grid item container direction='column' lg alignItems={matchesMD ? 'center':undefined}>
          <Grid item>
            ...
            align={matchesMD ? 'center':undefined}
            > {/* using a hexidecimal for color vs name is more performant on website */}
              Consultation
            </Typography>
          </Grid>
          <Grid item >
            ...
            Whether you already have an idea for where to start and what to do, or if you just know you want to step things up, 
            ...
            <Typography variant='body1' paragraph style={{color:'#fff', maxWidth:'20em'}} >
            Cutting-edge advancements in machine learning like object detection and natural language processing allow computers to do things previously unimaginable, 
            and our expertise and intuition will help usher you into this new future of possibilities.
            </Typography>
          </Grid>
        </Grid>
        <Grid item lg 
        style={{alignSelf: 'center'}} // alignSelf property allows you to force an item by itself than the other items inside its own container.
        >
          <img 
          src={consultation} 
          alt='handshake' 
          width='100%' // 100% width ensures image will shrink down/grow and take up proper space avaiable to them appropriately. More evident in medium screen size for an example.
          style={{maxWidth: 700, marginTop: matchesMD ? '2em': 0}}
          />
        </Grid>
      </Grid>
      <Grid item container 
      ...
      >
        <Grid item container direction='column' lg alignItems={matchesMD ? 'center': undefined}>
          <Grid item>
            <Typography variant='h4' gutterBottom style={{color:'#000', marginTop: '5em'}} > {/* using a hexidecimal for color vs name is more performant on website */}
              Mock Up
            </Typography>
          </Grid>
          <Grid item >
            ...
            That’s just a fancy term for a mockup, which doesn’t include colors, images, or any other polished design elements, 
        ...
        >
          ...
          width='100%' // 100% width ensures image will shrink down/grow and take up proper space avaiable to them appropriately. More evident in medium screen size for an example.
          style={{maxWidth: 1000, marginTop: matchesMD ? '2em': 0}}
          />
        </Grid>
      </Grid>
      <Grid item container 
      ...
      >
        ...
        style={{alignSelf: 'center'}} // alignSelf property allows you to force an item by itself than the other items inside its own container.
        >
          <img src={review} alt='magnifying glass' width='100%' style={{marginTop: matchesMD ? '2em': 0}}/>
        </Grid>
      </Grid>
      <Grid item container 
        direction={matchesMD ? 'column':"row"}
      ...
      >
        ...
        style={{alignSelf: 'center'}} // alignSelf property allows you to force an item by itself than the other items inside its own container.
        >
         <img src={design} alt='paintbrush leaving stroke paint' width='100%' style={{maxWidth: matchesMD ? 700 :1000, marginTop: matchesMD ? '2em': 0}}/>
        </Grid>
      </Grid>
      ...
      >
        <Grid item container direction='column' lg alignItems={matchesMD ? 'center':undefined}>
          <Grid item>
            <Typography variant='h4' gutterBottom style={{color:'#000', marginTop: '5em'}} align={matchesMD ? 'center': undefined} > {/* using a hexidecimal for color vs name is more performant on website */}
              Review
            </Typography>
          </Grid>
          <Grid item >
            ...
            Again this gives you an opportunity to tweak things and make sure we get everything right the first time.            </Typography>
          </Grid>
        </Grid>
        <Grid item lg 
        style={{alignSelf: 'center'}} // alignSelf property allows you to force an item by itself than the other items inside its own container.
      ...
      >
        <Grid item container direction='column' lg alignItems={matchesMD ? 'center':undefined}>
          ...
          <Grid item >
            ...
            <Typography variant='body1' paragraph style={{color:'#fff', maxWidth:'20em'}} align={matchesMD ? 'center': undefined} >
            Engineering begins after your approval on the final designs. We start by scaffolding out the project 
            on a high level, prioritizing some areas over others.
          </Typography>
            <Typography variant='body1' paragraph style={{color:'#fff', maxWidth:'20em'}} align={matchesMD ? 'center': undefined}>
        ...
        style={{alignSelf: 'center'}} // alignSelf property allows you to force an item by itself than the other items inside its own container.
        >
          <img src={build} alt='construction building site'  width='100%' style={{maxWidth: matchesMD ? 700 : 1000, marginTop: matchesMD ? '2em': 0}}/>
        </Grid>
      </Grid>
      <Grid item container 
        direction={matchesMD ? 'column':"row"}
      ...
      >
        ...
        style={{alignSelf: 'center'}} // alignSelf property allows you to force an item by itself than the other items inside its own container.
        >
          <img src={launch} alt='rocket launch' width='100%' style={{maxWidth: 300, maxHeight: 1300}}/>
        </Grid>
      </Grid>
      <Grid item container 
        direction={matchesMD ? 'column':"row"}
      ...
      >
        <Grid item container direction='column' lg alignItems={matchesMD ? 'center':undefined}>
          ...
          <Grid item >
            ...
            <Typography variant='body1' paragraph style={{color:'#fff', maxWidth:'20em'}} align={matchesMD ? 'center': undefined}>
            From there on out we make sure your application is kept up to date and taking advantage of the best features and practices available. When new developments arise or new techniques are discovered in future projects, we will implement those advancements 
        ...
        style={{alignSelf: 'center'}} // alignSelf property allows you to force an item by itself than the other items inside its own container.
        >
          <img src={maintain} alt='wrench tightening bolts'width='100%' style={{maxWidth: matchesMD ? 700 : 500, marginTop: matchesMD ? '2em': 0}}/>
        </Grid>
      </Grid>
      <Grid item container 
        direction={matchesMD ? 'column':"row"}
      ...
      >
        ...
        style={{alignSelf: 'center'}} // alignSelf property allows you to force an item by itself than the other items inside its own container.
        >
          <img src={iterate} alt='dominos' width='100%' style={{maxWidth: matchesMD ? 700 : 1000, marginTop: matchesMD ? '2em': 0}}/>
        </Grid>
      </Grid>
