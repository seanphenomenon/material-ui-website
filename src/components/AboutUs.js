  ...
  return (
    <Grid container direction="column">
      ...
      >
        <Grid item>
          {" "}
          {/*nested grit item container here in order to add space-around justification to wrapping row container above*/}
          <Grid
            item
            container
            direction="column"
      ...
      <Grid
        ...
        container
        direction="column"
        alignItems="center" //alignItems on column will align them horizontally.
        className={classes.rowContainer}
