...
exports.sendMail = functions.https.onRequest((request, response) => {
  ...
  cors(request, response, () => {
    const { name, email, phone, message } = request.query; // this is where we are destructuring each query param out as its own constant, to get access to them for the sent email.
